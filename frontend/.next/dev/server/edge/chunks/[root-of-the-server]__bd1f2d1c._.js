...
function middleware(req) {
    ...
    // Garde que les 30 dernières secondes
    ipRequests[ip] = ipRequests[ip].filter((time)=>time > Date.now() - 30000);
    // plus de 30 requêtes en 30 secondes = blocage
    if (ipRequests[ip].length > 30) {
