...
"use client"; // ⚠ nécessaire pour le useEffect et useRouter
;
;
;
;
...
function RootLayout({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "RootLayout.useEffect": ()=>{
            // Vérifie le token côté client
            const token = document.cookie.split("; ").find({
                "RootLayout.useEffect": (row)=>row.startsWith("auth_token=")
            }["RootLayout.useEffect"])?.split("=")[1];
            // Si on est pas sur /auth et pas de token → redirection
            if (!window.location.pathname.startsWith("/auth") && !token) {
                router.replace("/auth");
            }
        }
    }["RootLayout.useEffect"], [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c4a5a22f._.js.map